...
if(mysqli_num_rows($query) > 0)
{
	...
	$published= $usr->user_trackability;
...
if(isset($_POST['Submit'])){	
	...
	if(!empty($alt_password)){
		...
		if(mysqli_num_rows($dd)>0){
    		...
    		$messages["alt_password"]["msg"]="Falsches altes Passwort";;
    		$err++;	
	    }
	}
...
<head>
<meta charset="utf-8">
<title>Kontoeinstellungen | <?php echo SITE_NAME; ?></title>
                          ...
                          <div class="alert alert-<?php echo $alert_type; ?> <?php echo $alert_box_show; ?>">
                            ...
                            <?php echo $alert_message; ?>
                               ...
                               <div class="form-group <?php echo $messages["user_first_name"]["status"] ?>">
                              		<label class="control-label col-md-4" for="user_first_name">Vorname <span class="required">*</span></label>
                              		<div class="col-md-4">
                              ...
                              <div class="form-group <?php echo $messages["user_last_name"]["status"] ?>">
                              		<label class="control-label col-md-4" for="user_last_name">Nachname <span class="required">*</span></label>
                              		<div class="col-md-4">
                              ...
                              <div class="form-group <?php echo $messages["user_email"]["status"] ?>">
                              		<label class="control-label col-md-4" for="user_email">E-Mail <span class="required">*</span></label>
                              		<div class="col-md-4">
                              ...
                              <div class="form-group">
										<label class="control-label col-md-4">Aktuelles Profilbild</label>
										<div class="col-md-8">
                              ...
                              <div class="form-group ">
										<label class="control-label col-md-4">Profilbild</label>
										<div class="col-md-8">
											<div class="fileinput fileinput-new" data-provides="fileinput">
											...
											<div class="clearfix margin-top-10">
												...
												HINWEIS!</span> Größe 40 X 40 Pixel.
											</div>
										</div>
									</div>
                             ...
                             <h3 class="form-section">Login Info</h3> 
                              ...
                              <div class="form-group <?php echo $messages["user_name"]["status"] ?>">
                              		<label class="control-label col-md-4" for="user_name">Benutzername <span class="required">*</span></label>
                              		<div class="col-md-4">
                           	  ...
                           	  <div class="form-group <?php echo $messages["alt_password"]["status"] ?>">
                              		<label class="control-label col-md-4" for="alt_password">Altes Passwort <span class="required">*</span></label>
                              		<div class="col-md-4">
                                 		...
                                 		<span for="alt_password" class="help-block">Geben Sie bitte das alte Passwort um das Passwort zu ändern<br></span>
                              		</div>
                           	  </div>
                              
                              <div class="form-group <?php echo $messages["user_password"]["status"] ?>">
                              		<label class="control-label col-md-4" for="user_password">Neues Passwort <span class="required">*</span></label>
                              		<div class="col-md-4">
                              ...
                              <div class="form-group <?php echo $messages["cpassword"]["status"] ?>">
                              		<label class="control-label col-md-4" for="cpassword">Neues Passwort bestätigen <span class="required">*</span></label>
                              		<div class="col-md-4">
                              ...
                              <div class="form-group last <?php if($published==0) echo 'hide'; ?>">
                                  <label for="published" class="control-label col-md-4">Statistik teilen?</label>
                                  <div class="col-md-6">
                                     <select class="form-control input-xsmall" name="published">
                                        <option <?php if($published==1) echo 'selected="selected"'; ?> value="1">Ja</option>
                                        <option <?php if($published==0) echo 'selected="selected"'; ?> value="0">Nein</option>
                                     </select><span for="published" class="help-block">Du kannst den Status nur einmal ändern.</span>
                                  </div>
                              </div>
