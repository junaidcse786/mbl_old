                           ...
                           <tr class="odd gradeX">
							  ...
							  if($role_id==16){
									...
									if($row->user_charge==1)
                                            ...
                                            echo '<span class="label label-md label-warning">No</span> <a class="btn default btn-xs blue" href="'.SITE_URL_ADMIN.'member_manager/impersonate_user.php?user_id='.$row->user_id.'&user_name='.$row->user_name.'" target="_blank">Impersonate</a>';                                            
