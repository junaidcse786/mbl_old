                             ...
                             <h3 class="form-section">Login Info</h3> 
                              ...
                              <div class="form-group <?php echo $messages["user_name"]["status"] ?>">
                           	  ...
                           	  <div class="form-group <?php echo $messages["alt_password"]["status"] ?>">
                              		<label class="control-label col-md-3" for="alt_password">Altes Passwort <span class="required">*</span></label>
                              		<div class="col-md-4">
                              ...
                              <div class="form-group <?php echo $messages["cpassword"]["status"] ?>">
                              		<label class="control-label col-md-3" for="cpassword">Neues Passwort bestätigen <span class="required">*</span></label>
                              		<div class="col-md-4">
