...
{	
	...
	if($err == 0)
	{
		...
		$sql = "INSERT INTO ".$db_suffix."hangman SET h_words='$h_words', h_topic='$h_topic', h_status='$h_status'";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                <?php echo $menus["$mKey"]["$pKey"]; ?> <small>Add the superterm and the subterms</small>
                                        </h3>
                                        <div class="page-bar">         
